...
Below we have two different examples of food chains. We can see how differently they deal with food inspections. On one hand **Giodarnos**, a local brand seems to be doing well while **dollar tree** is struggling to pass food inspections. We are comparing these on purpose as they illustrate two different standings of restaurants. This difference can also be found in the results of food inspections.

{% include bokeh_giodarnos.html %}

{% include bokeh-dollar.html %}
